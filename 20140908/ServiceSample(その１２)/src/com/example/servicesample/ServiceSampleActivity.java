...
public class ServiceSampleActivity extends Activity {
	...
	private ActivityInfo[] activites = {
		...
		new ActivityInfo(R.id.button_service_broadcast, ServiceBroadcastSample.class),
		new ActivityInfo(R.id.button_service_broadcast, ServiceBroadcastSample.class),
		new ActivityInfo(R.id.button_service_notification, ServiceNotificationSample.class),	};
